CLASS zcl_so_load_v1 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC.
  ...
  PROTECTED SECTION.
  PRIVATE SECTION.
    TYPES: tt_hdr TYPE STANDARD TABLE OF zcld_so_hdr_v1 WITH EMPTY KEY,
           tt_itm TYPE STANDARD TABLE OF zcld_so_itm_v1 WITH EMPTY KEY.
ENDCLASS.



CLASS zcl_so_load_v1 IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    ...
    DO 105 TIMES.
      ...
      DATA lv_hdr_netwr TYPE zcld_so_hdr_v1-netwr.
      lv_hdr_netwr = 0.
      ...
      DO 2 TIMES.
        ...
        DATA(lv_qty)   = CONV zcld_so_itm_v1-kwmeng( lv_pos * 10 ).
        DATA(lv_netpr) = CONV zcld_so_itm_v1-netpr( 100 + ( lv_idx MOD 50 ) ).
        DATA(lv_netwr) = CONV zcld_so_itm_v1-netwr( lv_qty * lv_netpr ).
    ...
    DELETE FROM zcld_so_itm_v1.

    INSERT zcld_so_hdr_v1 FROM TABLE @lt_hdr.
    INSERT zcld_so_itm_v1 FROM TABLE @lt_itm.
